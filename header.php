...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url(
        get_template_directory_uri()
    ); ?>/assets/css/styles.css?ver=<?php echo rand(111, 999); ?>">
</head>
<body>
    <div id="backdrop"></div>
    <div class="menu">
     ...
     echo esc_url(home_url());
 endif; ?>#que-es-vitalhealth">Compañía</a>
                    </li>
                    <li>
                        <a <?php if (
                            is_home()
     ...
     echo esc_url(home_url());
 endif; ?>#oportunidad-de-crecimiento-top">Oportunidad</a>
                    </li>
                    <li>
    ...
    "Carrito"
                                ...
                                <i id="shopping-cart" class="fa-solid fa-cart-shopping"></i> <span class="d-none d-lg-inline-block">Carrito</span> (<span class="cart-contents-count"><?php echo esc_html(
                                    $count
                                ); ?></span>)
                            </a>
                        <?php endif; ?>
