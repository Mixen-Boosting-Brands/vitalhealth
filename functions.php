...
function my_header_add_to_cart_fragment( $fragments ) {
    ...
    <?php if ( $count > 0 ) { ?>
        <a class="cart-contents" href="<?php echo WC()->cart->get_cart_url(); ?>" title="<?php _e( 'Carrito' ); ?>">
            <i id="carrito" class="fas fa-shopping-cart"></i> <span class="d-none d-lg-inline-block">Carrito</span> (<span class="cart-contents-count"><?php echo esc_html( $count ); ?></span>)
        </a>
    <?php } ?>
    <?php
